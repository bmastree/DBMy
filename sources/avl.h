...
#define HEAD_FILE sizeof(long)*2;
#define BYTES_TO_NEXTDEL 0
#define BYTES_TO_LEFT  sizeof(long)
#define BYTES_TO_RIGHT  sizeof(long)*2
#define BYTES_TO_HEIGHT  sizeof(long)*3
#define BYTES_TO_DATA sizeof(long)*3+sizeof(int)
